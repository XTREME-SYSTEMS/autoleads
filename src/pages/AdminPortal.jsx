...
import {
  Activity, AlertTriangle, BarChart3, Check, CheckCircle2, Clock, Database,
  Flag, Loader2, MapPin, Plus, RefreshCw, Rocket, Search, Shield, ShieldCheck,
...
export default function AdminPortal() {
  ...
  return (
    <div className="flex min-h-screen bg-[#fafafa]">
      ...
      <aside className="sticky top-0 h-screen w-[240px] shrink-0 bg-[#0b0b0b]">
        ...
        <header className="sticky top-0 z-30 border-b border-black/10 bg-white/95 backdrop-blur">
          <div className="flex items-center gap-3 px-6 py-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-black capitalize">{section === 'client' ? 'Client Preview' : section}</h1>
                <p className="text-xs text-black/50">Full system control · {section === 'client' ? 'View & edit the client experience' : 'Admin dashboard'}</p>
              </div>
            </div>
