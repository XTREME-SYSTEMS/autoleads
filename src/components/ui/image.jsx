...
/** JS wrapper boundary for responsive image polymorphism. */
...
const ImageWrapper = forwardRefAny(({ aspectRatio, className, style, children }, ref) => (
  <span
    ref={ref}
...
const ResponsiveImage = forwardRefAny(
